...
public class EaseTitleBar extends RelativeLayout {
    ...
    private void parseStyle(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            if (null != leftDrawable) {
                leftImage.setBackground(leftDrawable);
            }
    ...
    public void setLeftFont(Typeface titleFont) {
        leftImage.setTypeface(titleFont);
    }

    public void setRightFont(Typeface titleFont) {
        rightImage.setTypeface(titleFont);
    }
