...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        EMMessage message = getItem(position);
        try {
            if (message.getStringAttribute("message_type") != null && message.getStringAttribute("message_type").equals("100")) {
                View     view     = LayoutInflater.from(parent.getContext()).inflate(R.layout.add_group_notify, parent, false);
                TextView textView = (TextView) view.findViewById(R.id.notify_add_group);
                textView.setText(((EMTextMessageBody) message.getBody()).getMessage());
                return view;
            }
