...
public class EaseConversationListFragment extends EaseBaseFragment {
    ...
    public OnClickListener getRightClick() {
        return rightClick;
    }
    ...
    public OnClickListener getLeftClick() {
        return leftClick;
    }
    ...
    protected void initView() {
        ...
        titleBar.setRightText("群聊");
        titleBar.setTitle("消息");
        AssetManager assetManager = getActivity().getAssets();
        Typeface     typeface     = Typeface.createFromAsset(assetManager, "fonts/pangzhonghua.ttf");
        titleBar.setTitleFont(typeface);
        titleBar.setLeftFont(typeface);
        titleBar.setRightFont(typeface);
        titleBar.setLeftLayoutClickListener(leftClick);
        titleBar.setRightLayoutClickListener(rightClick);
